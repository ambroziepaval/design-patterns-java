...
class HotDrinkMachine {
    private Map<AvailableDrink, IHotDrinkFactory> factories = new EnumMap<>(AvailableDrink.class);
    ...
    public HotDrinkMachine() throws Exception {
        ...
        for (AvailableDrink drink : AvailableDrink.values()) {
            ...
            Class<?> factory = Class.forName("creational.factories." + factoryName + "Factory");
        ...
        Set<Class<? extends IHotDrinkFactory>> types =
                new Reflections("creational.factories") // ""
